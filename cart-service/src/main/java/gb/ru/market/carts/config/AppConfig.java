package gb.ru.market.carts.config;

import gb.ru.market.carts.properties.ProductServiceIntegrationProperties;
...
public class AppConfig {
    ...
    @Autowired
    public AppConfig(ProductServiceIntegrationProperties properties) {
